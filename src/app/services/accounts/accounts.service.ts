...
private url = 'https://api.ifalogistics-proline.theworkpc.com/api'
  ...
  upsertOpbal(pcode: string, title: string, name: string, type: string, add1: string, add2: string, add3: string, phone1: string, phone2: string, email: string,mobile: string, glcode: string,status: string, remarks: string, taxno: string, branch: string, accType: string, accCategory: string,crcpr: string,year: string,opbal:number) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    ...
    return this.http.post(this.url + '/opbal/upsertRecord', JSON.stringify(newTran), { headers: headers })
  }
  ...
  upsertParty(pcode: string, partyid: string, name: string, type: string, add1: string, add2: string, add3: string, phone1: string, phone2: string, email: string,mobile: string) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    ...
    return this.http.post(this.url + '/opbal/upsert-party', JSON.stringify(newTran), { headers: headers })
  }
